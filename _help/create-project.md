...
There is a brief description for each project type next to each project type option. If the description is insufficient, more information on each project type is available at [Project Types help page](http://docs.zanata.org/en/latest/user-guide/projects/project-types/index.html).
