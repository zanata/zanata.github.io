	...
	<xsl:template match="/zi:interface">
		<html>
			<head>
				...
				<link rel="stylesheet" type="text/css" href='https://raw.githubusercontent.com/zanata/zanata.github.io/master/files/0install//resources/feed.css'/>
			</head>
			<body>
				<div class="site">
					<div class="title">
						<a href="https://raw.githubusercontent.com/zanata/zanata.github.io/master/files/0install/">https://raw.githubusercontent.com/zanata/zanata.github.io/master/files/0install/</a>
					</div>
					<div class="main">
						<div class="content">
