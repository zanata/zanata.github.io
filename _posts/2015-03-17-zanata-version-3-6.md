...
Zanata now requires JMS to be configured in standalone.xml in order to queue up some messages going out of the system. For instructions on how to do this, please [See Here](http://docs.zanata.org/en/latest/user-guide/system-admin/configuration/jms-messaging)
